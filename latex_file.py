...
for i in range(sites):
    for j in range(sites):
        ...
        plt.figure(i)
        plt.scatter(lesser_compressive_angular_frequency_values,lesser_compressive,c='orange',s=100)
...
for i in range(sites):
    for j in range(sites):
        ...
        plt.figure(i)
        plt.scatter(greater_compressive_angular_frequency_values,greater_compressive,c='red',s=100)
