...
class Discrete_Cosine_Transform:
    def __init__(self,start_time,stop_time,number_of_samples,signal_in_time):
        ...
        self.signal_in_time = signal_in_time
    ...
    def get_dct(self):
        return fft_from_scipy.dct(self.signal_in_time)/self.number_of_samples